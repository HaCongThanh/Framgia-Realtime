...
@section('content')
    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="page-header">
                ...
                <div class="header-sub-title">
                    <nav class="breadcrumb breadcrumb-dash">
                        ...
                        <a class="breadcrumb-item" href="{{ route('room-types.index') }}">{{ __('messages.room_type') }}</a>
            ...
            <div class="card">
                <div class="card-body">
                    {!! Form::open(['route' => ['room-types.update', $room_type->id], 'method' => 'PUT', 'files' => true ]) !!}
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($errors->has('room_size'))
                                        <span class="label-agree-term" role="alert">
                                            <strong style="color: red;">{{ $errors->first('room_size') }}</strong>
                                        </span>
                                    @endif
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($errors->has('bed'))
                                        <span class="label-agree-term" role="alert">
                                            <strong style="color: red;">{{ $errors->first('bed') }}</strong>
                                        </span>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    @if ($errors->has('max_people'))
                                        <span class="label-agree-term" role="alert">
                                            <strong style="color: red;">{{ $errors->first('max_people') }}</strong>
                                        </span>
                                    @endif
                                </div>
