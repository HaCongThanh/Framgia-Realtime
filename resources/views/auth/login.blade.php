                    ...
                    <div class="form-content-box">
                        ...
                        <div class="details">
                            <form method="POST" action="{{ route('user.login') }}">
                                ...
                                <div class="svgContainer">
                                    <div>
                                        <svg class="mySVG" viewBox="0 0 200 200">
                                            ...
                                            <circle cx="100" cy="100" r="100" fill="#3ac4fa"/>
                                            <g class="body">
                                ...
                                <div class="form-group">
                                    <input id="email" type="text" name="email" class="input-text form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email') }}" required autofocus placeholder="Địa chỉ Email">
                                ...
                                <div class="form-group">
                                    <input id="password" type="password" name="password" class="input-text form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" required placeholder="Mật khẩu">
                                ...
                                <div class="checkbox">
                                    ...
                                    <a href="{{ route('password.request') }}" class="link-not-important pull-right">Quên mật khẩu</a>
                        ...
                        <div class="footer">
                            @if (Route::has('register'))
                                <span>
                                    Bạn chưa có tài khoản? <a href="{{ route('user.register') }}">Đăng ký ở đây</a>
                                </span>
                            @endif
                        </div>
                    </div>
