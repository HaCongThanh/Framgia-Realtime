...
<!-- Mirrored from storage.googleapis.com/themevessel-items/hotel-alpha/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jul 2018 11:21:13 GMT -->
<head>
    <!-- Google Tag Manager -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ mix('css/hotel-alpha/bootstrap.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ mix('css/hotel-alpha/animate.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ mix('css/hotel-alpha/bootstrap-submenu.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ mix('css/hotel-alpha/bootstrap-select.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('fonts/font-awesome/css/font-awesome.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('fonts/flaticon/font/flaticon.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('fonts/linearicons/style.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ mix('css/hotel-alpha/jquery.mCustomScrollbar.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ mix('css/hotel-alpha/bootstrap-datepicker.min.css') }}">

    <!-- Custom stylesheet -->
    <link rel="stylesheet" type="text/css" href="{{ mix('css/hotel-alpha/style.css') }}">
    <link rel="stylesheet" type="text/css" id="style_sheet" href="{{ mix('css/hotel-alpha/blue-light-2.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ mix('css/hotel-alpha/ie10-viewport-bug-workaround.css') }}">

    <!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
    <!--[if lt IE 9]><script  src="js/ie8-responsive-file-warning.js"></script><![endif]-->
    <script src="{{ mix('js/hotel-alpha/ie-emulation-modes-warning.js') }}"></script>
...
<script src="{{ mix('js/hotel-alpha/jquery-2.2.0.min.js') }}"></script>
<script src="{{ mix('js/hotel-alpha/bootstrap.min.js') }}"></script>
<script src="{{ mix('js/hotel-alpha/bootstrap-submenu.js') }}"></script>
<script src="{{ mix('js/hotel-alpha/jquery.mb.YTPlayer.js') }}"></script>
<script src="{{ mix('js/hotel-alpha/wow.min.js') }}"></script>
<script src="{{ mix('js/hotel-alpha/bootstrap-select.min.js') }}"></script>
<script src="{{ mix('js/hotel-alpha/jquery.easing.1.3.js') }}"></script>
<script src="{{ mix('js/hotel-alpha/jquery.scrollUp.js') }}"></script>
<script src="{{ mix('js/hotel-alpha/jquery.mCustomScrollbar.concat.min.js') }}"></script>
<script src="{{ mix('js/hotel-alpha/jquery.filterizr.js') }}"></script>
<script src="{{ mix('js/hotel-alpha/bootstrap-datepicker.min.js') }}"></script>
<script src="{{ mix('js/hotel-alpha/app.js') }}"></script>
...
<!-- Mirrored from storage.googleapis.com/themevessel-items/hotel-alpha/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jul 2018 11:21:16 GMT -->
</html>